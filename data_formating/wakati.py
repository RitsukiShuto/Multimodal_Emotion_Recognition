...
def main():
    ...
    df_un_wakati.to_csv("../data/wakachi/un_labeled_wakati.txt", index=False)

    df_half_wakati = pd.DataFrame(half_labeled_wakati)
    df_half_wakati.to_csv("../data/wakachi/half_wakati.txt", index=False)

    df_full_wakati = pd.DataFrame(full_labeled_wakati)
    df_full_wakati.to_csv("../data/wakachi/full_wakati.txt", index=False)
